...
public class NguoiDung implements UserDetails { // Thêm "implements UserDetails"
    ...
    @Column(name = "ho_ten", columnDefinition = "NVARCHAR(100)", nullable = false, length = 100 )
    ...
    @Column(name = "vai_tro", columnDefinition = "NVARCHAR(100)", length = 50)
    ...
    @Column(name = "tinh_thanh_pho",columnDefinition = "NVARCHAR(100)", length = 100)
    private String tinhThanhPho;

    @Column(name = "quan_huyen", columnDefinition = "NVARCHAR(100)",length = 100)
    private String quanHuyen;

    @Column(name = "phuong_xa",columnDefinition = "NVARCHAR(100)", length = 100)
    private String phuongXa;

    @Column(name = "chi_tiet_dia_chi",columnDefinition = "NVARCHAR(100)")
